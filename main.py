...
def test_scenario():
    ...
    click_('/html/body/div/div/div[2]/div[2]/section/div[2]/div/div[2]/div/div/div[2]/div/div/div[2]/div/div['
           '4]/button[1]')
    ...
    click_(
        '/html/body/div/div/div[2]/div[2]/section/div[2]/div/div[2]/div/div/div[1]/button/svg')  # закрыть окно авторизации
    click_(
        '/html/body/div/div/div[2]/div[4]/section/div/span[1]/div/div/div/span[3]/div/div/button[3]/svg')  # раскрываем список chat
    click_('/html/body/div/div/div[2]/div[4]/section/div/span[1]/div/div/div/span[3]/div/div[2]/div/div[1]/div['
           '1]/div[2]/button')  # try it
